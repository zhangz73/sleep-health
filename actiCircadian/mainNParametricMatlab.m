function[IS, IV, L5,M10,L5mid,M10mid,RA,logAmp,numdays,days,nightsleep,nightrest]=mainNParametricMatlab(timeInHours,actigraphy,sleep,rest);
...
for jj=1:numdays
    ...
    if (numel(find(~isnan(daysig)))<0.8*24*60)
