...
out_fname = "regression_results.docx"
...
output_name_dct_raw = {
    "diastolic_BP": {"Name": "Diastolic Blood Pressure (mmHg)", "Category": "Blood Pressure", "Model": "linear"},
    "BMXBMI": {"Name": "BMI (kg/m^2)", "Category": "Metabolic Outcomes", "Model": "linear"},
    "systolic_BP": {"Name": "Systolic Blood Pressure (mmHg)", "Category": "Blood Pressure", "Model": "linear"},
    "LBXGLU": {"Name": "Fasting Glucose (mg/dl)", "Category": "Metabolic Outcomes", "Model": "linear"},
    "BMXWAIST": {"Name": "Waist Circumference", "Category": "Metabolic Outcomes", "Model": "linear"},
    "cvd_status": {"Name": "Cardiovascular Disease", "Category": "Blood Pressure", "Model": "logist"},
    "diabetes_status": {"Name": "Type 2 Diabetes", "Category": "Cardiometabolic Outcomes", "Model": "logist"},
    "HTN_status": {"Name": "Hypertension", "Category": "Blood Pressure", "Model": "logist"},
    "central_adiposity": {"Name": "Central Adiposity", "Category": "Cardiometabolic Outcomes", "Model": "logist"},
    "HTN_old_status": {"Name": "Hypertension old definition", "Category": "", "Model": "logist"},
    "Obesity": {"Name": "Obesity", "Category": "Cardiometabolic Outcomes", "Model": "logist"},
}
...
for i in range(1, len(lines)):
    ...
    if curr_var != "" and curr_var == prev_var:
        ...
        row = [str(arr[0]).replace(curr_input, input_readable), str(arr[1]), str(arr[2]), str(arr[3]), tidy_pval2(arr[4])]
        rows.append(row)
    prev_var = curr_var
...
for reg_model in reg_model_lst:
    for category in output_name_dct[reg_model]:
        ...
        output_lst = [x[0] for x in output_name_dct[reg_model][category]] #list(set(df_sub["Output"]))
