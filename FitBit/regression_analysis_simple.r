...
df_all <- read.csv("Merged.csv", strip.white = T)
            ...
            for(adj in c(1)){
                ...
                if(push){
                    ...
                    if(model_name == "linear"){
                        ...
                        model <- lm(formula_m, data = df_curr)
...
input_name_lst <- c("IS60", "IV60", "M10_midpoint", "M10_cnt", "M10_cnt_100", "L5_midpoint", "L5_cnt", "RA")
output_name_lst_linear <- c("morning_SBP", "morning_DBP", "evening_SBP", "evening_DBP", "average_SBP", "average_DBP")
